...
//   // Master menu ko open/close karne ka state
...
//                 to="/master/merchants"
//                 className={`px-10 py-2.5 text-sm transition-colors ${
//                   location.pathname === "/master/merchants"
//                     ? "text-blue-400 font-bold"
//                     : "text-gray-400 hover:text-white"
//                 }`}
//               >
...
//                 to="/master/models"
//                 className={`px-10 py-2.5 text-sm transition-colors ${
//                   location.pathname === "/master/models"
//                     ? "text-blue-400 font-bold"
//                     : "text-gray-400 hover:text-white"
//                 }`}
//               >
...
//           <Link
//             to="/orders-report"
//             className={`flex items-center px-6 py-3 transition-colors uppercase text-sm font-medium ${
