      ...
      <div className="bg-white border border-gray-200 rounded-xl overflow-hidden flex flex-col flex-1 shadow-sm">
        ...
        <div className="flex justify-between items-center px-5 py-3.5 border-b border-gray-100 flex-shrink-0 flex-wrap gap-4">
          <div className="flex items-center gap-3">
            ...
            <button className="flex items-center gap-2 border border-gray-200 px-4 py-2 rounded-full text-[13px] text-gray-600 hover:bg-gray-50 font-medium transition-colors">
              <IconFilter /> Filter
            </button>
          </div>

          <div className="flex items-center gap-2.5">
            <button className="p-2 border border-gray-200 text-gray-500 hover:bg-gray-50 rounded-md transition-colors">
              <IconDownload />
            </button>
            <button
              onClick={() => {
                ...
                {filteredData.length === 0 ? (
                  ...
                  filteredData.map((row, index) => (
                    <tr
                      ...
                      className="border-b border-gray-100 hover:bg-slate-50 transition-colors"
                    >
                      {/* Note: Decreased padding (px-3 py-1.5) for high density */}
                      ...
                      <td className="px-3 py-1.5 text-center font-bold text-slate-800 border-r border-gray-100 whitespace-nowrap">
                        {row.actual_qty}
                      </td>

                      {/* Name can be long, so allowing wrap */}
                      <td className="px-3 py-1.5 font-medium text-gray-700 border-r border-gray-100 whitespace-normal min-w-[150px] break-words leading-tight">
                        {row.audited_by}
                      </td>
          ...
          <div className="bg-white rounded-xl w-full max-w-3xl shadow-2xl overflow-hidden flex flex-col">
              ...
              >
                ...
                <div className="col-span-2">
                  ...
                  <textarea
                    ...
                    required={formData.preview_status === "Discrepancy"}
                    placeholder="E.g., Box was damaged, missing 2 pieces..."
                    className="w-full bg-white border border-gray-300 p-2.5 rounded-md focus:border-[#f97316] outline-none text-[13px] min-h-[70px] custom-scrollbar"
                  ></textarea>
                </div>
              </form>
            </div>
            ...
            <div className="flex justify-end gap-3 px-6 py-4 border-t border-gray-100 bg-gray-50 rounded-b-xl">
              <button
                type="button"
                onClick={() => setIsFormModalOpen(false)}
                className="px-5 py-2.5 bg-white border border-gray-300 font-bold rounded-md text-[13px] text-gray-600 hover:bg-gray-100 transition-colors"
              >
                Cancel
              </button>
              <button
                ...
                form="auditForm"
                disabled={loading || formData.expected_qty === ""}
                className={`px-6 py-2.5 text-white font-bold rounded-md text-[13px] shadow-sm transition-colors disabled:opacity-50 flex items-center gap-2 ${
                  formData.preview_status === "Discrepancy"
                    ? "bg-rose-600 hover:bg-rose-700"
                    : "bg-[#f97316] hover:bg-[#ea580c]"
                }`}
