    ...
    <div className="bg-transparent min-h-screen font-sans pb-10">
      ...
      <div className="flex flex-col xl:flex-row justify-between items-start xl:items-end mb-8 gap-4 border-b border-gray-200 pb-5">
        ...
        <div className="flex flex-wrap gap-3 items-center">
          ...
          <button
            onClick={handleExportExcel}
            className="bg-white border border-gray-200 text-slate-700 hover:text-blue-700 hover:border-blue-200 hover:bg-blue-50 px-4 py-2.5 rounded-lg font-bold text-xs uppercase tracking-wider shadow-sm transition flex items-center gap-2"
          >
                ...
                orders.map((order, index) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      {showCol("show_merchant") && (
                        <td className="p-4 text-slate-800 font-medium text-[13px]">
                          {order?.merchant || "-"}
                        </td>
                      )}
                      {showCol("show_merchant_id") && (
                      ...
                      {showCol("show_model_name") && (
                        <td
                          className="p-4 text-slate-700 font-medium text-[13px]"
                          title={order?.model_name}
                        >
                          {order?.model_name || "-"}
                        </td>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-4 gap-5 mb-5">
                    <div>
                      ...
                      <input
                        ...
                        onChange={handleHeaderChange}
                        disabled={editMode}
                        className="w-full bg-gray-50 border border-gray-200 p-2.5 rounded-lg text-sm font-bold text-slate-900 focus:ring-1 focus:ring-slate-300 outline-none transition"
                      />
                    </div>
                    <div>
                      <label className="block text-[10px] font-bold text-slate-600 uppercase tracking-widest mb-1.5">
                      ...
                      <input
                        ...
                        value={headerData.txn_date}
                        onChange={handleHeaderChange}
                        className="w-full bg-gray-50 border border-gray-200 p-2.5 rounded-lg text-sm font-medium text-slate-700 focus:ring-1 focus:ring-slate-300 outline-none"
                      />
                    </div>
                    <div>
                      <label className="block text-[10px] font-bold text-slate-600 uppercase tracking-widest mb-1.5">
                  ...
                  <div className="flex justify-between items-end mb-3 px-1">
                    ...
                    {!editMode && (
                      <button
                        type="button"
                        onClick={handleAddItem}
                        className="text-amber-600 hover:text-white bg-amber-50 hover:bg-amber-500 px-3 py-1.5 rounded-md text-[10px] font-bold uppercase tracking-widest transition-all"
                      >
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-3 gap-5 mb-5">
                        <div>
                          ...
                          <select
                            ...
                            value={item.asin_fsn}
                            onChange={(e) => handleItemChange(index, e)}
                            className="w-full bg-gray-50 border border-gray-200 p-2.5 rounded-lg text-sm font-bold text-slate-800 focus:ring-1 focus:ring-slate-300 outline-none"
                          >
                        ...
                        <div>
                          ...
                          <input
                            ...
                            value={item.model_name}
                            readOnly
                            className="w-full bg-gray-100 border border-transparent p-2.5 rounded-lg text-sm font-medium text-slate-500 cursor-not-allowed"
                          />
                        </div>
                        <div>
                          <label className="block text-[10px] font-bold text-slate-400 uppercase tracking-widest mb-1.5">
                      ...
                      <div className="grid grid-cols-2 md:grid-cols-6 gap-5">
                        <div>
                          ...
                          <select
                            ...
                            value={item.order_status}
                            onChange={(e) => handleItemChange(index, e)}
                            className="w-full bg-gray-50 border border-gray-200 text-slate-800 font-bold p-2.5 rounded-lg text-sm outline-none focus:ring-1 focus:ring-slate-300"
                          >
                            <option value="Open">Open</option>{" "}
                            <option value="Complete">Complete</option>{" "}
                            <option value="Cancelled">Cancelled</option>
                        ...
                        <div>
                          ...
                          <input
                            ...
                            value={item.order_qty}
                            onChange={(e) => handleItemChange(index, e)}
                            className="w-full bg-gray-50 border border-gray-200 p-2.5 rounded-lg text-sm font-bold text-slate-800 outline-none focus:ring-1 focus:ring-slate-300 text-center"
                          />
                        </div>
                        <div>
                          <label className="block text-[10px] font-bold text-slate-600 uppercase tracking-widest mb-1.5">
                          ...
                          <input
                            ...
                            value={item.order_amount}
                            onChange={(e) => handleItemChange(index, e)}
                            className="w-full bg-gray-50 border border-gray-200 p-2.5 rounded-lg text-sm font-bold text-slate-800 outline-none focus:ring-1 focus:ring-slate-300"
                          />
                        </div>
                        <div>
                          <label className="block text-[10px] font-bold text-slate-600 uppercase tracking-widest mb-1.5">
                          ...
                          <input
                            ...
                            value={item.payment_amount}
                            onChange={(e) => handleItemChange(index, e)}
                            className="w-full bg-gray-50 border border-gray-200 p-2.5 rounded-lg text-sm font-bold text-emerald-600 outline-none focus:border-emerald-500 focus:ring-1 focus:ring-emerald-200"
                          />
                        </div>
                        <div>
                          <label className="block text-[10px] font-bold text-slate-400 uppercase tracking-widest mb-1.5">
                          ...
                          <input
                            ...
                            disabled
                            value={`₹ ${item.unit_price}`}
                            className="w-full bg-gray-100 border border-transparent p-2.5 rounded-lg text-sm font-bold text-slate-500 text-right"
                          />
                        </div>
                        <div>
            ...
            <div className="px-8 py-8 overflow-y-auto custom-scrollbar bg-gray-50/50 rounded-b-2xl">
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
                <div className="bg-emerald-50/50 p-4 rounded-xl border border-emerald-100 shadow-sm">
                  <label className="block text-[10px] font-bold text-emerald-600 uppercase tracking-widest mb-1">
                    Delivered Qty
                  </label>
                ...
                <div className="bg-red-50/50 p-4 rounded-xl border border-red-100 shadow-sm">
                  <label className="block text-[10px] font-bold text-red-600 uppercase tracking-widest mb-1">
                    Cancel Qty
                  </label>
