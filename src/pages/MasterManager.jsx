...
export default function MasterManager() {
  ...
  return (
    <div className="bg-[#f8f9fa] min-h-screen font-sans pb-4 text-slate-700">
      {/* HEADER */}
      <div className="bg-white px-6 py-4 border-b border-gray-200 flex flex-col md:flex-row justify-between items-center gap-4 animate-in fade-in slide-in-from-top-4 duration-500 rounded-t-xl mb-4">
        <div>
          <p className="text-[12px] text-gray-400 font-medium mb-1 tracking-wide">
            Modules / <span className="text-slate-600">Master Data</span>
          </p>
      ...
      <div className="mx-6 mb-4 flex gap-3 overflow-x-auto pb-2 [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none] animate-in fade-in slide-in-from-bottom-8 duration-700 delay-100 fill-mode-both">
        {tabs.map((tab) => (
          <button
            key={tab.id}
            onClick={() => navigate(`/master/${tab.id}`)}
      ...
      <div className="mx-6 bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden flex flex-col animate-in fade-in slide-in-from-bottom-8 duration-700 delay-200 fill-mode-both">
          ...
          {role === "ADMIN" && (
            <div className="flex items-center gap-3 w-full md:w-auto overflow-x-auto [&::-webkit-scrollbar]:hidden pb-1 md:pb-0">
              ...
              {selectedIds.length > 0 && (
                <button
                  onClick={handleBulkDelete}
                  className="flex items-center gap-2 px-4 py-2.5 bg-red-50 text-[#ff4d4f] border border-red-100 rounded-[10px] text-[12px] font-bold shadow-sm transition whitespace-nowrap hover:bg-red-100"
                >
                  <IconTrash /> Delete ({selectedIds.length})
                </button>
              )}
        ...
        {/* 🔥 UNIFORM HIGH-DENSITY DATA TABLE 🔥 */}
        <div className="overflow-auto custom-table-scrollbar w-full flex-1 border-t border-gray-200 min-h-[75vh] max-h-[calc(100vh-100px)] bg-white relative">
          {loading ? (
                ...
                {filteredData.length === 0 ? (
                  ...
                  filteredData.map((item, index) => (
                    ...
                    >
                      ...
                      {currentTab === "models" ? (
                        <>
                          <td className="px-3 py-1.5 border border-gray-200 whitespace-nowrap text-[13px] font-bold text-slate-700 font-mono">
                            {item.asin_fsn}
                          </td>
                          <td className="px-3 py-1.5 border border-gray-200 whitespace-normal min-w-[200px] break-words leading-snug text-[13px] text-slate-800 font-bold">
                            {item.model_name}
                          </td>
                          <td className="px-3 py-1.5 border border-gray-200 whitespace-nowrap text-[13px] text-slate-600 font-medium font-mono">
                            {item.model || "—"}
                          </td>
                          <td className="px-3 py-1.5 border border-gray-200 whitespace-nowrap text-[12px] text-gray-500 text-center font-mono">
                            {item.sap_polyshri || "—"}
                          </td>
                          <td className="px-3 py-1.5 border border-gray-200 whitespace-nowrap text-[12px] text-gray-500 text-center font-mono">
                            {item.sap_rio || "—"}
                        ...
                        <>
                          <td className="px-3 py-1.5 border border-gray-200 whitespace-nowrap text-[13px] font-bold text-slate-700 tracking-wider font-mono">
                            {item.gstn_no}
                          </td>
                          <td className="px-3 py-1.5 border border-gray-200 whitespace-normal min-w-[200px] break-words leading-snug text-[13px] text-slate-800 font-bold">
                            {item.name}
                        ...
                        <td className="px-3 py-1.5 border border-gray-200 whitespace-normal min-w-[250px] break-words leading-snug text-[13px] text-slate-800 font-bold">
                          {item.name}
                        </td>
                      )}
      ...
      {isModalOpen && role === "ADMIN" && (
        <div className="fixed inset-0 bg-slate-900/40 backdrop-blur-sm flex items-center justify-center z-50 p-4 animate-in fade-in duration-200">
          <div className="bg-white rounded-2xl w-full max-w-lg shadow-2xl flex flex-col max-h-[90vh] animate-in zoom-in-95 overflow-hidden">
            ...
            <div className="p-6 overflow-y-auto custom-scrollbar bg-[#f0f2f5]/40">
              <form
                id="masterForm"
                onSubmit={handleSubmit}
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                    <div>
                      ...
                      <input
                        ...
                        value={formData.gstn_no}
                        onChange={handleInputChange}
                        className="w-full bg-white border border-gray-200 p-2.5 rounded-xl focus:border-[#1677ff] focus:ring-4 focus:ring-blue-50 outline-none text-[13px] font-bold text-slate-800 uppercase transition-all"
                        placeholder="e.g. 23XXXXX..."
                      />
                    </div>
                    <div>
                      ...
                      <input
                        ...
                        value={formData.name}
                        onChange={handleInputChange}
                        className="w-full bg-white border border-gray-200 p-2.5 rounded-xl focus:border-[#1677ff] focus:ring-4 focus:ring-blue-50 outline-none text-[13px] font-bold text-slate-800 transition-all"
                        placeholder="e.g. Next Era"
                      />
                    </div>
                  </div>
                  ...
                  <div className="space-y-5">
                    ...
                    <div>
                      ...
                      <input
                        ...
                        value={formData.model || ""}
                        onChange={handleInputChange}
                        className="w-full bg-white border border-gray-200 p-2.5 rounded-xl focus:border-[#1677ff] focus:ring-4 focus:ring-blue-50 outline-none text-[13px] font-semibold text-slate-800 transition-all"
                        placeholder="Optional code"
                      />
                    </div>
                  </div>
                ...
                {(currentTab === "models" || currentTab === "sellers") && (
                  <div className="pt-4 mt-2 border-t border-gray-100">
                    <p className="text-[11px] font-bold text-gray-400 uppercase tracking-widest mb-4 flex items-center gap-2">
                      <i className="fas fa-server text-[#1677ff]"></i> SAP
                      Integrations
                    </p>
                      ...
                      {[
                        ...
                        >
                          ...
                          <input
                            ...
                            value={formData[sapKey] || ""}
                            onChange={handleInputChange}
                            className="w-full bg-white border border-gray-200 p-2.5 rounded-xl focus:border-[#1677ff] focus:ring-4 focus:ring-blue-50 outline-none text-[13px] font-mono text-slate-800 transition"
                          />
                        </div>
                      ))}
                    </div>
      ...
      {isUploadModalOpen && (
        <div className="fixed inset-0 bg-slate-900/40 backdrop-blur-sm flex items-center justify-center z-50 p-4 animate-in fade-in duration-200">
          <div className="bg-white rounded-2xl w-full max-w-md shadow-2xl flex flex-col max-h-[90vh] animate-in zoom-in-95 overflow-hidden">
            <div className="flex justify-between items-center px-6 py-5 border-b border-gray-100 bg-white">
              <div>
                <h3 className="text-[18px] font-bold text-slate-800 tracking-tight">
                  Bulk Upload {currentTab === "sellers" ? "Sellers" : "Models"}
                ...
                <p className="text-[12px] text-gray-400 font-medium mt-0.5">
                  Upload multiple records using an Excel file.
                </p>
              </div>
              <button
                onClick={() => setUploadModalOpen(false)}
            ...
            <div className="p-8 overflow-y-auto custom-scrollbar bg-[#f0f2f5]/40">
              <div className="mb-6 bg-blue-50 border border-blue-100 p-5 rounded-2xl">
                ...
                <div className="flex flex-wrap gap-2">
                  {uploadHeaders.map((h, i) => (
                    <span
                      key={i}
                      className="px-2.5 py-1 bg-white border border-blue-200 text-[#1677ff] text-[10px] font-bold uppercase tracking-widest rounded-md shadow-sm"
                    >
                      {h}
                    </span>
                  ))}
              ...
              <form onSubmit={handleUploadSubmit}>
                <div className="border-2 border-dashed border-gray-300 p-8 text-center rounded-2xl bg-white hover:bg-gray-50 transition-colors mb-6 group cursor-pointer relative">
                  <input
                    type="file"
                    accept=".xlsx, .xls, .csv"
                    onChange={handleFileChange}
                  ...
                  {file && (
                    <p className="text-[12px] font-bold text-[#e67e22] mt-4 bg-orange-50 py-1.5 rounded-md inline-block px-3 border border-orange-100">
                      {file.name}
                    </p>
                  )}
                </div>
                <button
                  type="submit"
                  disabled={loading}
                  className="w-full bg-[#1677ff] hover:bg-blue-600 text-white py-3.5 rounded-xl font-bold uppercase tracking-widest text-[12px] transition shadow-md shadow-blue-500/20 disabled:opacity-50 flex items-center justify-center gap-2"
                >
                  {loading ? (
                    <>
